...
/**
 * This is the model class for table "tblreligion".
 *
 * The followings are the available columns in table 'tblreligion':
 * @property integer $ReligionId
 * @property string $ReligionName
 * @property string $Ifms_Code
 * @property string $Ifms_Desc
 */
class Tblreligion extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('ReligionName', 'length', 'max'=>15),
			array('Ifms_Code', 'length', 'max'=>5),
			array('Ifms_Desc', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ReligionId, ReligionName, Ifms_Code, Ifms_Desc', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Tblreligion the static model class
	 */
