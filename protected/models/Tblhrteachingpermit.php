...
/**
 * This is the model class for table "tblhrteachingpermit".
 *
 * The followings are the available columns in table 'tblhrteachingpermit':
 * @property integer $id
 ...
 */
class Tblhrteachingpermit extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('Date, Remarks, DateModified', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, Date, FullName, ICPassportNo, DepartmentId, WorkingStatusId, Remarks, DateModified, StaffId, StatusId', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Tblhrteachingpermit the static model class
	 */
