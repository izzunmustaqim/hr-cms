                    ...
                    <table id="ks-datatable" class="table table-striped table-bordered" width="100%">
                        ...
                        <?php $i=1;foreach($data as $data){ ?>
                            <tr>
                                ...
                                <td style="text-align: left"><?php echo $data['PositionName'];?></td>
                                <td style="text-align: center"><?php echo $data['DepartmentDesc'];?></td>
                                <td style="text-align: center"><?php echo $data['WorkingStatusDesc'];?></td>
                                <td style="text-align: center"><?php echo date('d-m-Y',strtotime($data['CloseDate']));?></td>
