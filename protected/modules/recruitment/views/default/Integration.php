                        ...
                        <?php $i=1;foreach($data as $data){ ?>
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <button type="button" class="btn btn-danger btn-sm" onclick="window.location='<?php echo Yii::app()->baseURL; ?>/recruitment/default/integrate/id/<?php echo $data['UserId']?>'">Integrate</button>
                                </td>
                            </tr>
                            <?php $i++;} ?>
                        </tbody>
