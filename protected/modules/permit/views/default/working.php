                        ...
                        <?php $i=1;foreach($data as $data){ ?>
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location='<?php echo Yii::app()->baseURL; ?>/permit/default/addworking/id/<?php echo $data['id']?>'">Edit</button>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="window.location='<?php echo Yii::app()->baseURL; ?>/permit/default/addworking/id/<?php echo $data['id']?>'">Details</button>
                                </td>
                            </tr>
                            <?php $i++;} ?>
                        </tbody>
