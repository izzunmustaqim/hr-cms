            ...
            <section class="ks-title">
                ...
                <div class="ks-controls">
                    <nav class="breadcrumb ks-default">
                        ...
                        <span class="breadcrumb-item active" href="#">Working Permit</span>
                    </nav>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <h5 class="card-title">Working Permit Details</h5>
                                    <?php $form = $this->beginWidget('CActiveForm',array('htmlOptions'=>array('autocomplete'=>'off','enctype'=>'multipart/form-data'))); ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="disabled-input" class="col-sm-1 form-control-label">Permit</label>
                                        <div class="col-sm-11">
                                            <?php echo $form->textField($model, 'PermitNo', array('class' => 'form-control')); ?>
                                            <?php echo $form->error($model, 'PermitNo'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="disabled-input" class="col-sm-1 form-control-label">From</label>
                                        <div class="col-sm-11">
                                    ...
                                    <div class="form-group row">
                                        <label for="disabled-input" class="col-sm-1 form-control-label">To</label>
                                        <div class="col-sm-11">
