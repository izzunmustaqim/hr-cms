...
<table width="100%">
  <tr>
    <th><?php echo Helper::translate('srbac','Telah dipilih') ?></th>
    <th>&nbsp;</th>
    <th><?php echo Helper::translate('srbac','Senarai peranan') ?></th>
  </tr>
  <tr><td width="45%">
    ...
    <td width="10%" align="center">
      ...
      if(SHtml::listData( $data['userAssignedRoles'], 'name', 'name')){            
     	 $data['assign']['disabled'] =true;
      } else {
      	 $data['assign']['disabled'] =false;
      }
