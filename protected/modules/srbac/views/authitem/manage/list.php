...
<style>
	...
	a:hover {color:#658DB3;text-decoration:none;}
	.ac_input {border:1px solid #C0C0C0;}
	.srbacDataGrid select {border:1px solid #C0C0C0;}
</style>
...
<?php
       echo SHtml::ajaxLink(
         Helper::translate('srbac', '<i class=" icon-plus"></i> Daftar item baru'),
         array('create'),
         array(
             'type' => 'POST',
             'update' => '#preview',
    ...
    <?php
       echo Helper::translate('srbac', 'Carian') . ': &nbsp; ';
    ...
    <?php
       echo SHtml::imageButton($this->module->getIconsPath() . '/preview.png',
         array(
             'border' => 0,
             'title' => Helper::translate('srbac', 'Carian'),
             'live' => false,
             'ajax' => array(
   ...
   <table class="srbacDataGrid">
     <tr>
       <th><?php echo Helper::translate('srbac', 'Item'); ?></th>
       <th>
      <?php
       echo SHtml::dropDownList('selectedType', Yii::app()->user->getState("selectedType"),
         AuthItem::$TYPES,
         array(
             'prompt' => Helper::translate('srbac', 'Semua'),
             'live' => false,
             'ajax' => array(
                 'type' => 'POST',
                 'url' => array('list'),
     ...
     <th colspan="2"><?php echo Helper::translate('srbac', 'Tindakan') ?></th>
   </tr>
      ...
      <?php
         echo SHtml::ajaxLink(
           SHtml::image($this->module->getIconsPath() . '/update.png',
             ...
             array('border' => 0, 'title' => Helper::translate('srbac', 'Kemaskini'))),
      ...
      <?php
           echo SHtml::ajaxLink(
             SHtml::image($this->module->getIconsPath() . '/delete.png'
               ...
               array('border' => 0, 'title' => Helper::translate('srbac', 'Hapus'))),
