                    ...
                    <table id="ks-datatable" class="table table-striped table-bordered" width="100%">
                        ...
                        <?php $i=1;foreach($data as $data){ ?>
                            <tr>
                                ...
                                <td style="text-align: center"><?php echo ($data['type'] == 1) ? "<span class='label label-info label-pill'>Internal</span>" : "<span class='label label-primary label-pill'>External</span>";?></td>
                                <td style="text-align: center">Active</td>
                                <td style="text-align: center">
                                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location='<?php echo Yii::app()->baseURL; ?>/training/default/add/id/<?php echo $data['id']?>'">Edit</button>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="window.location='<?php echo Yii::app()->baseURL; ?>/training/default/add/id/<?php echo $data['id']?>'">Participant</button>
                                </td>
                            </tr>
                            <?php $i++;} ?>
                        </tbody>
