                                ...
                                <div class="card-block">
                                    <div>
                                        ...
                                        <div id="prog_level" class="form-group">
                                            ...
                                            <div id="student" class="alert alert-danger" role="alert">
                                               Student to be supervise
                                            </div>
                                            
                                                <div id="student_name" class="form-group">
                                                <label for="email-2" class="control-label">i) Student Name</label>
                                            ...
                                            <div id="student_id" class="form-group">
                                              ...
                                              <div id="student_name2" class="form-group">
                                                <label for="email-2" class="control-label">ii) Student Name</label>
                                                <?php echo $form->textField($model, 'student_name2', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_name2'); ?>
                                            </div>
                                            
                                            
                                            <div id="student_id2" class="form-group">
                                                <label for="email-2" class="control-label">Student Id</label>
                                                <?php echo $form->textField($model, 'student_id2', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_id2'); ?>
                                            </div>
                                            
                                             <div id="student_name3" class="form-group">
                                                <label for="email-2" class="control-label">iii) Student Name</label>
                                                <?php echo $form->textField($model, 'student_name3', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_name3'); ?>
                                            </div>
                                            
                                            
                                            <div id="student_id3" class="form-group">
                                                <label for="email-2" class="control-label">Student Id</label>
                                                <?php echo $form->textField($model, 'student_id3', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_id3'); ?>
                                            </div>
                                            
                                            <div id="student_name4" class="form-group">
                                                <label for="email-2" class="control-label">iv) Student Name</label>
                                                <?php echo $form->textField($model, 'student_name4', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_name4'); ?>
                                            </div>
                                            
                                            
                                            <div id="student_id4" class="form-group">
                                                <label for="email-2" class="control-label">Student Id</label>
                                                <?php echo $form->textField($model, 'student_id4', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_id4'); ?>
                                            </div>
                                            
                                            <div id="student_name5" class="form-group">
                                                <label for="email-2" class="control-label">v) Student Name</label>
                                                <?php echo $form->textField($model, 'student_name5', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_name5'); ?>
                                            </div>
                                            
                                            
                                            <div id="student_id5" class="form-group">
                                                <label for="email-2" class="control-label">Student Id</label>
                                                <?php echo $form->textField($model, 'student_id5', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'student_id5'); ?>
                                            </div>
                               ...
                               <?php echo $form->textField($model, 'letter_title', array('class' => 'form-control')); ?>
                                        ...
                                        <div id="position" class="form-group">
                                            ...
                                            <div id="salary" class="form-group">
                                             ...
                                             <div id="sup_hours" class="form-group">
                                                <label for="email-2" class="control-label">Supervision Hours/Candidate</label>
                                                <?php echo $form->textField($model, 'sup_hours', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'sup_hours'); ?>
                                            </div>
                                            
                                            <div id="sup_rate" class="form-group">
                                                <label for="email-2" class="control-label">Rate/Hour (RM)</label>
                                                <?php echo $form->textField($model, 'sup_rate', array('class' => 'form-control')); ?>
                                                <?php echo $form->error($model, 'sup_rate'); ?>
                                            </div>
