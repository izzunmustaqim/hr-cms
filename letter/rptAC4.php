...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">AC4</div>');
    $mpdf->SetHTMLFooter('
...
<br><br>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            <td align="justify">You shall be paid a salary of RM <?php money($result['salary']);?> (Ringgit Malaysia: <?php upper($obj->words) ?>) per month less
                statutory deductions if and where applicable.
            </td>
        </tr>
    </table>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            <td align="justify"><p>I....................................................., (NRIC/Passport No:..........................................), do hereby accept the terms and
                    conditions of employment with City University as set forth in
                    Appendix A (Terms and Conditions of Service).</p></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
  ...
  <sethtmlpageheader name="fourthpage" value="on" show-this-page="1"/>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="left" width="62%"><?php echo date('j<\up>S</\up> F Y',strtotime($result['date_contract_start']));?></td>
        </tr>
       <tr>
            <td valign="top" width="6%" align="center">4</td>
            <td valign="top" width="32%">Contract Duration</td>
            <td align="justify" width="62%">One (1) year, ending <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?>. Your Contract of Service may be extended subject to mutual agreement.</td>
        </tr>
        <tr>
            <td align="center" width="6%" valign="top">5</td>
            <td align="left" width="32%" valign="top">Reporting Line</td>
            <td align="justify" width="62%">You shall report to the <?php echo $result['report_to_id'];?>,<?php getFaculty($result['department_id'],$db);?> or any other officer as appointed by the Company.</td>
        </tr>
        <tr>
         ...
         <tr>
            ...
            <td align="justify" width="62%" valign="top">
                <br>- Please refer to your Job Description (Attached)<br>
        ...
        <tr>
            ...
            <td align="justify" width="62%">
                    <?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>) working days per completed year of service. Leave shall be applied 7 days in advance.</td>
        </tr>
    </table>
    <div style='page-break-after:always'>&nbsp;</div>
    <br><br>
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="62%"><p>You may be transferred or seconded to another department/division or any
                    ...
                    your experience, knowledge and skills.</p><br><br><br>
            </td>
        </tr>
        <tr>
            ...
            <td align="justify" width="62%">
                ...
                Kindly note with regard to this offer of employment you fully understand and agree that should you resign without giving the due notice or salary in lieu, City U reserves the right to inform your new employer that you quit without giving due notice and legal action is being pursued by City U.
            </td>
        </tr>
         <tr>
            ...
            <td align="justify" width="62%">Upon registration with the Human Resources Department, you will be covered
                ...
                You shall be granted medical benefits as stated in the Employee Handbook.
            </td>
        </tr>
      ...
      <table width="100%" class="table spacebar">
       <tr>
            ...
            <td align="justify" width="62%">
            The Company shall not be responsible for medical expenses incurred for self-inflicted injuries, suicide attempts, treatment of any sexually transmitted diseases (including AIDS) or injury suffered arising from participation in any
dangerous sports such as hand gliding, mountain climbing and scuba diving.<br>
            Medical benefits shall cover medical consultation, hospitalization and emergency treatment in approved hospitals or clinics,
            which are all subject to the Company’s sole and absolute discretion.<br>
          ...
          <tr>
              ...
              <td align="justify" width="62%">
                ...
                with or any Government or Regulatory Body. 
              </td>
          </tr>
      </table>
      <div style='page-break-after:always'>&nbsp;</div>
      ...
      <table width="100%" class="table spacebar">
          <tr>
              ...
              <td align="justify" width="62%">
             	A breach of this clause, shall result in the Company
        ...
        <tr>
         ...
         <tr>
            ...
            <td align="justify" width="62%">a)&nbsp; Except with the written permission of the Company, you shall not
                ...
                subsidiaries and its associated companies.</td>
            </tr>
      </table>
      <div style='page-break-after:always'>&nbsp;</div>
      <br><br>
        ...
        <tr>
         ...
         <tr>
            ...
            <td align="justify" width="62%">
                ...
                loyal, efficient, trustworthy and honest fashion.
            </td>
        </tr>
      </table>
    <div style='page-break-after:always'>&nbsp;</div>
        ...
        <tr>
            ...
            <td align="justify" width="62%">
             During the continuance of your employment with us, you will at all times faithfully and diligently
                ...
                quality of education provided by the Company.<br><br>
