...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">AC16</div>');
    $mpdf->SetHTMLFooter('
...
<br><br>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
         <td><b>CONTRACT FOR SERVICE – GUEST PROFESSOR FOR <?php getFacultyUpper($result['department_id'],$db);?></b></td>
        </tr>
        <tr>
            <td>
                <hr class="hr">
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            <td align="justify" height=""><p>
                   Following advice from the Vice-Chancellor, I am pleased to offer you an appointment as a Guest Professor in City University commencing on the <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start'])) ;?> and concluding on <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?>. 
        ...
        <tr>
            ...
            <td width="96%" align="justify">For all purposes of courtesy and on ceremonial occasions, you will be regarded as an academic staff member of the above work  unit and the University. However, you are not eligible to be a member of the Academic Board.</td>
            </tr>
                  <tr>
            <td width="4%" align="right">2.</td>
            <td width="96%" align="justify">When used in any documentation, including business cards, correspondence and publications, the title of Guest Professor must be used in its entirety so it is clear that the appointment is of a visiting nature.</td>
            </tr>
             <tr>
