...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">A1</div>');
    $mpdf->SetHTMLFooter('
...
<br><br>
    ...
    <table width="100%" class="spacebar">
        <tr>
            <td align="justify"><p>We are pleased to confirm our offer of employment to you as <?php getPosition($result['position_id'],$db);?>
                    ...
                    Company&quot;). You will report to the <?php echo $result['report_to_id'];?>, <?php getFaculty($result['department_id'],$db);?> or any other officer as appointed by the
   ...
   <div style='page-break-after:always'>&nbsp;</div>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            ...
            <br>hereby accept the terms and
                    ...
                    Appendix A and confirm herewith I shall report to work on the date specified. I am also fully aware and agree that if my services are not confirmed at the end of the probationary period, the question of giving me any notice with regard to termination of employment shall not arise.</p></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
    ...
    <table width="100%" class="table">
        ...
        <tr>
            <td align="center" width="8%" class="spacebar">6</td>
        ...
        <tr>
            <td align="center" width="8%" class="spacebar">7</td>
            ...
            <td align="justify" width="62%" class="spacebar"><p>Monday to Thursday - 8.30am to 5.30pm <br>(lunch break 1.00pm to 2pm)<br>
                    ...
                    the working hours may be subject to change due to operational requirements by the Company.
                </p></td>
        </tr>
        <tr>
            <td align="center" width="8%" class="spacebar">8</td>
            <td align="left" width="32%" class="spacebar">Duties & Responsibilities<br>
            i) 	Job Description<br>
            ii) Class Cancelation
            </td>
            <td align="left" width="62%" class="spacebar" align="justify"><br>- Please refer to your Job Description (Attached)<br>
        ...
        <tr>
            <td align="center" width="8%" class="spacebar">9</td>
            <td align="left" width="32%" class="spacebar">Annual Leave</td>
    ...
    <table width="100%" class="table">
    <tr>
            <td align="center" width="8%" class="spacebar">10</td>
            <td align="left" width="32%" class="spacebar">Sick Leave and Hospitalization leave</td>
            <td align="justify" width="62%" class="spacebar">You will be granted paid outpatient medical leave of up to 14 days per
        ...
        <tr>
            <td align="center" width="8%" class="spacebar">11</td>
            <td align="left" width="32%" class="spacebar">Transfer/Secondment</td>
            <td align="justify" width="62%" class="spacebar">You may be transferred or seconded to another department/division or any of
                the associate or subsidiary companies within the Group based on business needs and depending on your
                experience, knowledge and skills.
            </td>
        </tr>
        <tr>
            <td align="center" width="8%" class="spacebar">12</td>
            <td align="left" width="32%" class="spacebar">Termination of Employment</td>
            <td align="justify" width="62%" class="spacebar"><u>During Probation</u><br>
             Two (2) month notice from either party or two (2) month salary in lieu of such notice.<br>
             If an employee's services are terminated at the end of the probationary period, kindly note that the question of giving notice with regard to termination of employment shall not arise.<br><br>
                ...
                being taught, academics will have to ensure that the last day of service is to coincide either with the
                last day of semester or the day immediately<br><br>
            </td>
         </tr>
    </table>
    <div style='page-break-after:always'>&nbsp;</div>
    ...
    <table width="100%" class="table spacebar">
     <tr>
            <td align="center" width="8%" class="spacebar">&nbsp;</td>
            <td align="left" width="32%" class="spacebar">&nbsp;</td>
            <td align="justify" width="62%" class="spacebar">preceding the commencement of the semester, subject to the
                contractual notice period. Kindly note with regard to this offer of employment you fully understand and agree that should you
                resign without giving the due notice or salary in lieu, City University reserves the right to inform your new
                employer that you quit without giving due notice and legal action is being pursued by City University.</td>
         </tr>
        <tr>
            <td align="center" width="8%" valign="top">13</td>
    ...
    <table width="100%" class="table spacebar">
            <tr>
        <td align="center" width="8%" valign="top">14</td>
            ...
            <tr>
                <td align="center" width="8%" valign="top">15</td>
                ...
                <td align="justify" width="62%">The Company shall have the sole and exclusive right to all intellectual
                    ...
                    other than for serving the Company, 
                </td>
            </tr>
        </table>
    </div>
    ...
    <table width="100%" class="table spacebar">
       <tr>
                <td align="center" width="8%" valign="top">&nbsp;</td>
                <td align="left" width="32%" valign="top">&nbsp;</td>
                <td align="justify" width="62%">its subsidiaries or associated companies and shall not use them
        ...
        <tr>
            <td align="center" width="8%" valign="top">16</td>
        ...
        <tr>
            <td align="center" width="8%" valign="top">17</td>
    ...
    <table width="100%" class="table spacebar">
        <tr>
            <td align="center" width="8%" valign="top">18</td>
        ...
        <tr>
            <td align="center" width="8%" valign="top">19</td>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            <td align="center" width="8%" valign="top">20</td>
