...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">CC5</div>');
    $mpdf->SetHTMLFooter('
...
<br><br>
    ...
    <table width="100%">
        <tr>
            ...
            <td>&nbsp;:&nbsp;CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-CC5</td>
        </tr>
        <tr>
            <td>Date</td>
    ...
    <tr>
    <td align="justify">We are pleased to confirm our offer of employment to you as <?php getPosition($result['position_id'],$db);?> with City University (“The Company”). You will report to the <?php echo $result['report_to_id'];?> or any other officer as appointed by the Company. This position is based at the Petaling Jaya Main Campus at Menara City University.</td>
    </tr>
    <tr><td>&nbsp;</td></tr>
         <tr>
    <td align="justify">Your appointment with the Company is subject to you obtaining a satisfactory medical report including a chest X-ray from the Company’s appointed clinic and you being certified medically fit for employment.</td>
     ...
     <tr><td>&nbsp;</td></tr>
    <tr>
    <td align="justify">You shall be paid a salary of RM <?php money($result['salary']);?> (Ringgit Malaysia: <?php upper($obj->words) ?> only) per month less statutory deductions if and where applicable.</td>
    </tr>
     <tr><td>&nbsp;</td></tr>
  
      <tr>
    <td align="justify">The terms and conditions applicable to this appointment are attached herewith (Appendix A).</td>
    </tr>
    <tr><td>&nbsp;</td></tr>
      <tr>
    <td align="justify">This letter is given to you in duplicate. Your signature on the duplicate of this letter shall confirm your understanding and acceptance of terms and conditions of your employment.</td>
     ...
     <table width="100%" class="spacebar">
       <tr>
    <td align="justify">Kindly return the duplicate of this letter; duly signed to the Human Resource Department by <?php expiredofferdate($result['date_offer_end']); ?> failing which, this offer shall lapse. <br><br>You are also to note that once acceptance of this employment offer is confirmed by you and if you do not report to work on the specified date in Appendix A, you may subject yourself to legal action by City University.</td>
    </tr>
     </table>
     <br><br>
         <table width="100%">
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
          ...
          <br>hereby accept the terms and conditions of employment with City University as set forth in Appendix A (Terms and Conditions of Service).</p></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Our Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?></td>
        </tr>
    </table>
    ...
    <table width="100%" class="table">
    <tr>
    <td width="6%" height="50" align="center" class="spacebar"><b>No</b></td>
    ...
    <td align="center" width="62%" class="spacebar"><b>Description</b></td>
     ...
     <tr>
        ...
        <tr>
            ...
            <td align="left" width="62%" class="spacebar"><?php getPosition($result['position_id'],$db);?> ( Job Grade: <?php getPositionGrade($result['position_id'],$db);?> )</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" width="6%" class="spacebar">4</td>
            <td align="left" width="32%" valign="top" class="spacebar">Contract Duration</td>
            <td align="left" width="62%" valign="top" class="spacebar"><?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start']));?> to ending <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end']));?> Kindly note this contract shall end by efflux of time unless extended by mutual agreement.<br>In view of the foregoing, the question of the Company giving you notice about the expiry of the contract on <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end']));?> may not arise.</td>
        </tr>
        <tr>
            <td align="center" width="6%" valign="top" class="spacebar">5</td>
            <td align="left" width="32%" val ign="top" class="spacebar">Reporting Line</td>
        ...
        <tr>
            ...
            <td align="justify" width="62%" class="spacebar"><p>Monday to Thursday - 8.30am to 5.30pm <br>(lunch break 1.00pm to 2pm)<br>
                    Friday - 8.30am to 5.45pm <br>(Lunch break 12.30pm to 2.45pm)<br>
                    You maybe required to work on your off and rest  days with no additional payment. Please note that the working hours maybe  subject to change due to operational requirements by the Company.</p></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="justify" width="62%" class="spacebar"><?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>              ) working days. Leave shall be
                applied 7 days in advance.<br>
                Half of your unutilized leave accrued for the year may be carried forward to the subsequent calendar year.</td>
        </tr>
    </table>
<div style='page-break-after:always'>&nbsp;</div>
<br><br>
...
<tr>
        ...
        <tr>
            ...
            <td align="justify" width="62%">  
                ...
                Two (2) weeks’ notice from either party or two (2) weeks’ salary in lieu of such notice.<br><br>
                
                <u>Upon confirmation</u><br>
               One (1) month’s notice from either party or one (1) month’s salary in lieu of such notice.<br><br>
               The Company reserves the right to either reduce or waive the notice period if the Management deems that it would be in the Company’s interest to do so.
...
<br><br>
 <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="62%">Upon registration with the Human Resource Department, you will be covered under the Company’s Healthcare Plan.<br><br>
The Employee shall be granted medical benefits as stated in the employee handbook. The Company shall not be responsible for medical expenses incurred for self-inflicted injuries, suicide attempts, treatment of any sexually transmitted diseases (including AIDS) or injury suffered arising from participation in any dangerous sports such as hang gliding, mountain climbing and scuba diving.<br><br>
...
The Company shall provide outpatient and other medical expenses for you and your immediate family (legal spouse and children) up to a combined limit of RM 400.00 (Ringgit Malaysia: Four Hundred Only) per annum.<br><br>
...
Please refer to Employee Handbook on Medical/Sick Leave.
            ...
            <td align="left" width="32%" valign="top">Non-Disclosure and
                    Confidentiality</td>
            <td align="justify" width="62%">You shall never at any time during and after your employment with the Company disclose or divulge to any third party any information or matters relating to the Company or its business partners. This includes but not limited to the Company’s business plans, strategies, program contents or trade secrets.<br><br>
...
You shall not, except with prior written consent of the Chairman of the Board of Directors make direct or indirect statements public, whether to the press or in books, magazines, periodicals or by advertisement, radio, televisions, film, internet or any other medium with respect to any matter which might impair or injure the reputation of the Company or the relations of the Company’s companies, customers, or any other parties with whom the Company is working with or any Government or Regulatory Body.<br><br>
A breach of this clause, shall result in the Company instituting actions or remedies that it deems fit to safeguard its interest. <br>
...
<td align="left" width="32%" valign="top">Propriety Rights</td>
<td align="justify" width="62%">
...
<td align="justify" width="62%">
 ...
 <tr>
            ...
            <td align="justify" width="62%">
                All notices hereunder shall be made in writing and sent to the other party either in person, via an authorized representative or by A.R. Registered post.   Unless otherwise specified herein, the notice shall be deemed to have been received seven (7) working days after being duly deposited at the post office.<br><br><br><br><br><br>
            </td>
        </tr>
</table>
<div style='page-break-after:always'>&nbsp;</div>
...
reserves the right to do so entirely at its discretion.<br><br> Any alterations, amendments or additions to
these terms and conditions of service shall be advised to you in writing.
</td>
</tr>
<tr>
<td align="center" width="6%" valign="top">18</td>
<td align="left" width="32%" valign="top">Other Terms & Conditions</td>
<td align="justify" width="62%">
