...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">AC10(AR)</div>');
...
');
    ...
    <table width="100%">
        ...
        <tr>
            <td border="0010"><b>CONTRACT FOR SERVICE (ACADEMIC)</b></td>
        </tr>
        <tr>
            <td>
                <hr class="hr">
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="66%"><p>You shall report to the <?php echo $result['report_to_id'];?> or to any other person designated by the Company.</p>
            </td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        ...
        <tr>
            ...
            <td align="center" width="10%" valign="top">:</td>
            <td align="justify" width="66%"><p><?php echo date('d F Y',strtotime($result['date_contract_start']));?> to – <?php echo date('d F Y',strtotime($result['date_contract_end']));?><br>
                <?php echo $result['duration_extra'];?><br>
                You may be required to work on your off or rest days with no additional payment. Please note that the working hours maybe subject to change due to operational requirements by the City University("The Company")</td>
            </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="center" width="10%" valign="top">:</td>
            <td align="justify" width="66%"><p>Menara City University (PJ), Petaling Jaya</p></td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            ...
            <td valign="top" align="left">Your contract with City University may be terminated without prior
                notice if you:-
            </td>
        </tr>
    </table>
    ...
    <table width="100%" class="spacebar">
        <tr>
            ...
            <td valign="top" align="justify">Upon termination of your contract for service pursuant to Section 6.1 and
                ...
                you will be required to pay City University a penalty equivalent to the sum of <?php getContract($result['contract_id'])?>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            ...
            <td valign="top" align="justify"><p> Except with the written permission of the University, the you
                    ...
                    equipment, machinery, business affairs, transactions or property of the University. Your
                    ...
                    periodicals or by advertisement, radio, televisions, film,</p></td>
        </tr>
    </table>
    <div style='page-break-after:always'>&nbsp;</div>
    <table width="100%" class="spacebar">
        <tr>
            ...
            <td width="93%" align="justify" valign="top"><p>facsimile, internet or any other medium with respect to any
                    matter which might impair or injure the reputation of the University or the relations of the
                    University, the University companies, customers or subcontractors or any other
    ...
    <table width="100%" class="spacebar">
        <tr>
            <td align="justify">We look forward to your contribution towards the progress and development of City University.
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td width="30%" height="44">Signature<br>Date :</td>
        </tr>
    </table>
    </body>
<?php
