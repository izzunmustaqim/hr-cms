...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">AC6</div>');
    $mpdf->SetHTMLFooter('
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PROGRAMME -&nbsp;<?php getProgram($result['program_id'],$db);?>
...
<table width="100%" class="spacebar">
    ...
    <td>
        ...
        Teach the
		<?php if($result['subject_id1']!=NULL){echo $result['subject_id1']."(Class code:".$result['classcode_1'].")";}?><?php if($result['subject_id2']!=NULL){echo ",&nbsp;".$result['subject_id2']."(Class code:".$result['classcode_2'].")";}?><?php if($result['subject_id3']!=NULL){echo ",&nbsp;".$result['subject_id3']."(Class code:".$result['classcode_3'].")";}?><?php if($result['subject_id4']!=NULL){echo ",&nbsp;".$result['subject_id4']."(Class code:".$result['classcode_4'].")";}?><?php if($result['subject_id5']!=NULL){echo ",&nbsp;".$result['subject_id5']."(Class code:".$result['classcode_5'].")";}?> 
         for 
		<?php getProgram($result['program_id'],$db);?><?php if($result['program_id2']!=NULL){echo " & ";getProgram($result['program_id2'],$db); }?><?php if($result['program_id3']!=NULL){echo " & ";getProgram($result['program_id3'],$db); }?><?php if($result['program_id4']!=NULL){echo " & ";getProgram($result['program_id4'],$db); }?>
        </td>
        </tr>
        <tr>
        <td>&nbsp;</td>
    ...
    <tr>
    <td>&nbsp;</td>
    <td align="justify"><p>In consideration for the service rendered (as specified in 2 above) you will be paid at a rate of RM<?php upper($result['salary']);?> <?php if($result['duration_id']==0){ echo 'per month';} else if($result['duration_id']==1){ echo 'per hour';} else if($result['duration_id']==2){echo 'per duration';} ?>.<br><br>
   ...
   <table width="280" border="0">
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
         ...
         <tr>
            <td align="justify">With regard to the terms of payment for my services rendered I opt for my payment to be made as follows.<br>
            (Kindly &radic; accordingly)</td>
        </tr><tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>a) Be Paid monthly (&nbsp;&nbsp;&nbsp;)</td>
        </tr>
         <tr>
            <td>b) By the end of the semester (&nbsp;&nbsp;&nbsp;)</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
