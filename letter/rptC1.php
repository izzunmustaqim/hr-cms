...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">C1</div>');
    ...
    <div style='page-break-after:always'>&nbsp;</div>
        ...
        <table width="100%" class="table spacebar">
            <tr>
                ...
                <td align="justify" width="62%">
                   You shall not, except with prior written consent of the Chairman of the Board of Directors make direct or indirect statements public, whether to the press or in books, magazines, periodicals or by advertisement, radio, televisions, film, internet or
