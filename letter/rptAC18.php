...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-weight: bold; color:#000; font-size: 22pt; font-family: tahoma;">AC18</div>');
...
');
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
         <td><b>CONTRACT FOR SERVICE – ADJUNCT PROFESSOR</b></td>
        </tr>
        <tr>
            <td>
                <hr class="hr">
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            <td align="justify" height=""><p>                  
                   Following advice from the Vice-Chancellor, I am pleased to offer you an appointment as a Visiting Professor in City University commencing on <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start'])) ;?> and concluding on <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?>. 
        ...
        <tr>
            ...
            <td width="96%" align="justify">When used in any documentation, including business cards, correspondence and publications, the title of Adjunct Professor must be used in its entirety so it is clear that the appointment is of a visiting nature.</td>
            </tr>
             <tr>
    ...
    <table width="100%" class="spacebar">
        <tr>
            <td align="justify" height=""><p>
                   Should you wish to accept the above offer, please sign the enclosed copy of this letter and return same to the Human Resources Department by <?php expiredofferdate($result['date_offer_end']); ?>.
                </p></td>
        </tr>
        <tr>
            <td align="justify" height="">&nbsp;</td>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            ...
            <br>have read and understood the above terms and conditions of the offer herein stated, do hereby accept this offer of appointment.</p></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
