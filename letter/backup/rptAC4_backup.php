...
We are pleased to confirm our offer of employment to you as <b><?php getPosition($result['position_id'],$db);?></b> under <b><?php getFaculty($result['faculty_id'],$db);?></b> with City University(“The Company”). You will report to Dean, <b><?php echo $result['report_to_id'];?></b> or any other officer as appointed by the Company. This position is based at the Petaling Jaya Main Campus at Menara City University.<br><br>
...
Apart from the foregoing, as an educational institution we have to strictly comply with government regulation with regard to matters concerning teaching permit etc. You are herewith requested to note that, if for any reason your teaching permit application is rejected by the ministry concerned or if there is any objection from government authorities concerning your employment, your continued employment by us shall cease with immediate effect and the question of any payment of compensation shall not arise.<br><br>
You shall be paid a salary of <b>RM <?php money($result['salary']);?></b> (Ringgit Malaysia: <?php upper($obj->words) ?>) less statutory deductions if and where applicable.
</td>
</tr>
</table>
...
Kindly return the duplicate of this letter, duly signed to the Human Resource Department by <b><?php expiredofferdate($result['date_offer_end']); ?></b>  failing which, this offer shall lapse. <br><br>
...
<td width="62%" align="center"><strong>Description</strong></td>
</tr>
<tr>
<td align="center">1</td>
<td>Name</td>
<td><b><?php upper($result['name']);?></b></td>
</tr>
<tr>
<td align="center">2</td>
<td>Position</td>
<td><b><?php getPosition($result['position_id'],$db);?></b></td>
</tr>
<tr>
<td align="center">3</td>
<td>Commencement Date</td>
<td><b><?php echo date('j<\up>S</\up> F Y',strtotime($result['date_contract_start']));?></b></td>
</tr>
<tr>
<td align="center">4</td>
<td>Probation</td>
<td>Your probationary period is <b>six (6) months</b>.</td>
</tr>
<tr>
<td valign="top" align="center">5</td>
<td valign="top">Contract Duration</td>
<td align="justify"><b>One (1) year</b>, ending <b><?php echo date('j<\up>S</\up> F Y',strtotime($result['date_contract_end']));?></b>. Your Contract of Service may be extended subject to mutual agreement.</td>
</tr>
<tr>
<td valign="top" align="center">6</td>
<td valign="top">Reporting Line</td>
<td align="justify">You shall report to the <b>Dean, <?php echo $result['report_to_id'];?></b> or any other officer as appointed by the Company.</td>
</tr>
<tr>
<td valign="top" align="center">7</td>
<td valign="top">Working Hours</td>
<td align="justify"><b>Monday to Thursday</b> – 8.30am to 5.30pm (lunch break 1.00pm to 2.00pm)<br>
<b>Friday</b> – 8.30am to 5.45pm (Lunch break 12.30pm to 2.45pm)<br>
...
<td align="justify">-Please refer to your Job Description (Attached)<br>
...
<td align="justify"><b><?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>)</b> working days per completed year of service.  Leave shall be applied 7 days in advance.</td>
</tr>
<tr>
<td valign="top" align="center">10</td>
<td valign="top" align="left">Sick Leave and Hospitalization leave</td>
<td align="justify">You will be granted paid outpatient medical leave of up to fourteen (14) days per annum .  Hospitalization</td>
</tr>
</table>
<div style='page-break-after:always'>&nbsp;</div>
<br><br>
...
<td valign="top">&nbsp;</td>
<td align="justify">medical leave will be granted up to a maximum of sixty (60) days per completed year of service.  
...
<td align="justify">You may be transferred or seconded to another department/division or any of the associate or subsidiary companies within the Group based on business needs and depending on your experience, knowledge and skills.</td>
</tr>
<tr>
...
<b><u>Note : Resignation of Academic Staff</u></b><br><br>
As <b>the Company</b> is involved in providing education and in order not to disrupt completion of modules/ subjects being taught, academics will have to ensure that the last day of service is to coincide either with the last day of semester or the day immediately preceding the commencement of the semester, subject to the contractual notice period.<br><br>
Kindly note with regard to this offer of employment you fully understand and agree that should you resign without giving the due notice or salary in lieu, <b>the Company</b> reserves the right to inform your new employer that you quit without giving due notice and legal action is being pursued by <b>the Company</b>.
</td>
</tr>
</table>
<div style='page-break-after:always'>&nbsp;</div>
...
<td width="62%" align="justify">
<b>I.	CONDUCT (EXITING)</b><br><br>
During your employment with <b>the Company</b>, we will naturally wish your conduct to be such as not to discredit you or the Company and you will be expected to perform the duties assigned to you in a loyal, efficient, trustworthy and honest fashion.<br><br>
During the continuance of your employment with <b>the Company</b>, you will at all times faithfully and diligently perform and observe such duties as may from time to time be assigned to you by your superior and devote the whole of your time and attention to the discharge of the duties and functions devolved upon you.<br><br>
Whilst under our employment, you are not allowed to be involved directly or indirectly in any business contrary to Company’s interest without formal approval of the Chairman of the Board of Directors.  Breaching this would be a violation of your employment contract and could result in the termination of your employment.  You shall not divulge any matters, which may come to your knowledge, relating to the affairs of the Company or its employees.<br><br>
</td>
</tr>
</table>
<div style='page-break-after:always'>&nbsp;</div>
...
<td width="30%" valign="top" align="left">&nbsp;</td>
<td width="62%" align="justify">
<b>II.	COMPLIANCE WITH GOVERNMENT REQUIREMENTS/REGULATIONS.</b><br><br>
As you are employed as a Lecturer, you are required to take note that from time to time the government on its part may require our lecturers/concerned employees to update their skills in order to enhance the quality of education provided by <b>the Company</b>.<br><br>

Should such requirement/s arise it is your sole responsibility to upgrade your skills/qualifications etc. in order to comply with the government requirements/regulations eg: the need for certain category of academic staff to have a teaching methodology certificate.
</td>
</tr>
<tr>
