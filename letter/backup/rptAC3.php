...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-weight: bold; color:#000; font-size: 22pt; font-family: tahoma;">AC3</div>');
...
');
    ...
    <table width="100%">
        <tr>
            <td align="justify" height=""><p>We are pleased to confirm our offer of employment to you as <?php getPosition($result['position_id'],$db);?>
                    under <?php getFaculty($result['faculty_id'],$db);?> with City University College of Science and Technology (&quot;The
    ...
    <table width="100%" class="table">
        ...
        <tr>
            ...
            <td align="justify" width="60%"><p>
                    <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start'])) ;?> to <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?>. Kindly note this contract shall end by efflux of time unless extended by
                    mutual agreement.
        ...
        <tr>
            ...
            <td align="justify" width="60%"><p>
                    You shall report to the <?php echo $result['report_to_id'];?> or any other officer as appointed by the Company.
                </p></td>
        </tr>
        <tr>
            ...
            <td align="justify" width="60%">
                Monday to Thursday – 8.30am to 5.30pm (lunch break 1.00pm to 2pm)<br>
    ...
    <table width="100%" class="table">
        <tr>
            ...
            <td align="left" width="30%" valign="top">Duties & Responsibilities<br>
                <br>i) Job Description<br><br>
                ii) Class cancelation
            </td>
            <td align="left" width="60%" valign="top"><br><br>-Please refer to your Job Description (Attached)<br><br>
        ...
        <tr>
            ...
            <td align="justify" width="60%"><p>
                    Twelve (12) working days per completed year of service. Leave shall be applied 7 days in advance.
    ...
    <table width="100%" class="table">
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                As City U is involved in providing education and in order not to disrupt completion of modules/ subjects
                ...
                City UC reserves the right to inform your new employer that you quit without giving due notice and legal
                action is being pursued by City UC.
            </td>
        </tr>
    ...
    <table width="100%" class="table">
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                but not limited to the Company’s business plans, strategies, program contents or trade secrets.<br><br>
                ...
                instituting actions or remedies that it deems fit to safeguard its interest.<br><br>
