...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">AC10(B)</div>');
    ...
    <table width="100%">
        <tr>
            ...
            <td width="93%" align="justify" valign="top"><p>facsimile, internet or any other medium with respect to any
                    matter which might impair or injure the reputation of the University College or the relations of the
                    University College, the University College’s companies, customers or subcontractors or any other
                    employers with whom The University College is working with or with any Government
