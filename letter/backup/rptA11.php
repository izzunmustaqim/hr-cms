...
function expiredoffer($date){
    echo date('d-m-Y', strtotime($date. '+7 weekday'));
}
...
foreach($result as $result) {
    ...
    <table width="100%">
        ...
        <tr>
            <td>Date</td>
            <td>&nbsp;:&nbsp;<?php echo date('d-m-Y',strtotime($result['date_offer']));?></td>
        </tr>
    </table>
    ...
    <table width="100%">
        <tr>
            <td align="justify" height=""><p>We are pleased to confirm our offer of employment to you as <?php getPosition($result['position_id'],$db);?> under <?php getFaculty($result['faculty_id'],$db);?> with City University College of Science and Technology (&quot;The
    ...
    <table width="100%">
        <tr>
            <td>xxxNamexxxxxx </td>
            <td align="right">Our Ref: CITYU/HRA/EXT/2016-000-A1</td>
        </tr>
    </table>
    ...
    <table width="100%" class="table">
        ...
        <tr>
            ...
            <td align="left" width="50%">xxxxxxxxxxxxxxxxxx</td>
        </tr>
        <tr>
            <td align="center" width="10%">2</td>
            <td align="left" width="40%" valign="top">Position</td>
            <td align="left" width="50%">Xxxxxxxxxxxxxxxxxx (Job Grade:    )</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" width="50%">xxxxxxxx</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" width="50%">You shall report to the Dean / Director�. or any other officer as appointed by the Company.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="justify" width="50%">.........(....) working days per completed year of service.  Leave shall be applied 7 days in advance.  <br><br>
