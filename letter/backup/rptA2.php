...
');
    ...
    <table width="100%">
        <tr>
            ...
            <td>&nbsp;:&nbsp;CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?></td>
        </tr>
        <tr>
            <td>Date</td>
    ...
    <table width="100%" class="adress">
        ...
        <tr>
            <td border="0010"><b>OFFER OF PERMANENT EMPLOYMENT</b></td>
        </tr>
        <tr>
            <td>
                <hr class="hr">
    ...
    <p>Your employment under a fixed term contract expires on <b><?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?></b>.<br><br>
    We are pleased to offer you employment as <b><?php getPosition($result['position_id'],$db);?></b> under <b><?php getFaculty($result['faculty_id'],$db);?></b> with City University (“The Company”) effective from
    <b><?php  echo date('j<\up>S</\up> F Y',strtotime($result['date_contract_start'])) ;?></b>. You shall be paid a salary of <b>RM <?php money($result['salary']);?></b> (Ringgit Malaysia: <?php upper($obj->words) ?> only) per month less statutory deductions.<br><br>
    The terms and conditions applicable to this appointment are contained in attachment (Appendix A).<br><br>
    This letter is given to you in duplicate. Your signature on the duplicate of this letter shall
    confirm your understanding and acceptance of terms and conditions of your employment. Kindly return the duplicate of this letter, duly signed to the Human Resources Department by <b><?php expiredofferdate($result['date_offer_end']); ?></b> failing which, this offer shall lapse.
</p>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?></td>
        </tr>
        <tr>
            <td colspan="2">
                <hr class="hr">
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="left" width="60%"><b><?php upper($result['name']);?></b></td>
        </tr>
        <tr>
            <td align="center" width="10%">2</td>
            <td align="left" width="30%" valign="top">Position</td>
            <td align="left" width="60%"><b><?php getPosition($result['position_id'],$db);?></b></td>
        </tr>
        <tr>
            <td align="center" width="10%">3</td>
            <td align="left" width="30%" valign="top">Commencement Date</td>
            <td align="left" width="60%"><b><?php echo date('j<\up>S</\up> F Y',strtotime($result['date_contract_start']));?></b></td>
        </tr>
        <tr>
            <td align="center" width="10%" valign="top">4</td>
            <td align="left" width="30%" valign="top">Reporting Line</td>
            <td align="left" width="60%">You shall report to <b>Dean, <?php getFaculty($result['faculty_id'],$db);?></b>, or any other officer as appointed by
                the Company.
            </td>
        </tr>
        <tr>
            <td align="center" width="10%" valign="top">5</td>
            <td align="left" width="30%" valign="top">Working Hours</td>
            <td align="justify" width="60%"><p><b>Monday to Thursday</b> – 8.30am to 5.30pm (lunch break 1.00pm to 2.00pm)<br>
        ...
        <tr>
            ...
            <td align="left" width="30%" valign="top">Duties & Responsibilities<br>
                i) Job Description<br>
                ii) Class cancelation
            </td>
            <td align="left" width="60%" valign="top">-Please refer to your Job Description (Attached)<br>
        ...
        <tr>
            ...
            <td align="justify" width="60%"><b><?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>)</b> working days per completed year of service. Leave shall be
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%">You may be transferred or seconded to another faculty/department or any of
        ...
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                <u><b>Note : Resignation of Academic Staff</b></u><br>
...
<br><br>Please refer to Employee Handbook on Medical/Sick Leave.
            ...
            <tr>
                ...
                <td align="justify" width="60%">
                    ...
                    press or in books, magazines, periodicals or by advertisement, radio, televisions, film, internet or
        ...
        <table width="100%" class="table spacebar">
            <tr>
                <td align="center" width="10%" valign="top">&nbsp;</td>
                <td align="left" width="30%" valign="top">&nbsp;</td>
                <td align="justify" width="60%">This may include the immediate termination of your employment and/or the instituting of legal
                    action.
                </td>
            </tr>
            <tr>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                loyal, efficient, trustworthy and honest fashion.<br>
                ...
                the whole of your time and attention to the discharge of the duties and functions devolved upon you.<br>
                <br><br><br><br><br><br>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                of academic staff to have a teaching methodology certificate.<br><br><br><br><br><br>
