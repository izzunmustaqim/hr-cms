...
$user = $db->query("SELECT * FROM tbluser WHERE UserId = $staff_id");
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-weight: bold; color:#999999; font-size: 22pt; font-family: tahoma, arial, verdana, sans-serif;>A1</div>');
    ...
    <td width="50%" style="text-align: right; ">aaa</td>
...
<td align="right">Ref: CITYU/HRA/EXT/2016-xxx</td>
</tr>
<tr>
