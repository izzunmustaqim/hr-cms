...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-weight: bold; color:#000; font-size: 22pt; font-family: tahoma;">AC3(2)</div>');
...
');
    ...
    <table width="100%" class="spacebar">
        <tr>
            <td align="justify" height=""><p>We are pleased to confirm our offer of employment to you as <b><?php getPosition($result['position_id'],$db);?></b>
                    under <b><?php getFaculty($result['faculty_id'],$db);?></b> with City University (&quot;The
                    Company&quot;). You will be reporting to the <b>Dean, <?php echo $result['report_to_id'];?></b> or any other officer as appointed by the
        ...
        <br>
        <tr>
            <td align="justify">You shall be paid a salary of <b>RM <?php money($result['salary']);?></b> (Ringgit Malaysia: <?php upper($obj->words) ?>) per month less
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            <td align="justify">Kindly return the duplicate of this letter, duly signed to the Human Resource Department
                by <b><?php expiredofferdate($result['date_offer_end']); ?></b> failing which, this offer shall lapse.
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="left" width="60%">Your probationary period is <b>six (6) months</b>.</td>
        </tr>
        <tr>
            <td align="center" width="10%" valign="top">5</td>
            <td align="left" width="30%" valign="top">Contract Duration</td>
            <td align="justify" width="60%"><p>
                    <b><?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start'])) ;?></b> to <b><?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?></b>. Kindly note this contract shall end by efflux of time unless extended by
                    mutual agreement.<br><br>
                    In view of the foregoing, the question of the Company giving you notice about the expiry of the
                    contract on <b><?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?></b> may not arise.
        ...
        <tr>
            ...
            <td align="justify" width="60%"><p>
                    You shall report to the <b>Dean, <?php echo $result['report_to_id'];?></b> or any other officer as appointed by the Company.
                </p></td>
        </tr>
        <tr>
            ...
            <td align="justify" width="60%">
                <b>Monday to Thursday</b> – 8.30am to 5.30pm (lunch break 1.00pm to 2.00pm)<br>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%"><p>
                    <b><?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>)</b> working days per completed year of service. Leave shall be applied 7 days in advance.
                </p></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="justify" width="60%"><p>You may be transferred or seconded to another department/division or any
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                <b><u>Note : Resignation of Academic Staff</u></b><br>

                As <b>the Company</b> is involved in providing education and in order not to disrupt completion of modules/ subjects
                ...
                resign without giving the due notice or salary in lieu,
                <b>the Company</b> reserves the right to inform your new employer that you quit without giving due notice and legal
                action is being pursued by <b>the Company</b>.
            </td>
        </tr>
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="60%">Upon registration with the Human Resource Department, you will be covered
                ...
                <b>You</b> shall be granted medical benefits as stated in the Employee Handbook. The Company shall not
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%">a)&nbsp; Except with the written permission of the Company, you shall not
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="60%">
                <b>I. CONDUCT </b><br>
                During your employment with <b>the Company</b>, we will naturally wish your conduct to be such as
                ...
                During the continuance of your employment with <b>the Company</b>, you will at all times faithfully and diligently
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                quality of education provided by <b>the Company</b>.<br>
                ...
                of academic staff to have a teaching methodology certificate.<br>
            </td>
        </tr>
        <tr>
