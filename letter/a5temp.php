...
');
    ...
    <table class="spacebar">
        ...
        <tr>
            <td>
                <b><?php upper($result['title']);?>. <?php uppercase($result['name']);?></b> (Passport No <b><?php echo $result['passport_no']?></b>) having a residential addressed at
                <b><?php if(($result['address1']!="") || ($result['address2']!="") ||  ($result['postcode']!="") || ($result['city']!="")  || ($result['country_id']!="") ) {?>
                    <?php echo $result['address1'];?>, <?php if($result['address2']!=NULL){ upper($result['address2']);echo ", "; }?><?php echo $result['postcode'];?><?php if($result['city']){ echo " ";upper($result['city']);} ;?>, <?php if($result['state']){ upper($result['state']);echo ", "; };?> <?php getCountry($result['country_id'],$db);?></b>
                <?php } else { ?>
                    &nbsp;-present-
                <?php } ?>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            <td align="center">&nbsp;</td>
            <td>
                <p><i>Mondays to Thursdays:	9.00 am – 5.00 pm (Lunch hour: 1.00 pm – 2.00 pm)<br>
