...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">A2(m)</div>');
...
');
    ...
    <table width="100%" class="spacebar">
        <tr>
            <td align="justify"><p>We are pleased to confirm our offer of employment to you as Marketing Executive with City University (&quot;The
                    Company&quot;). You will report to the Vice President Marketing, or any other officer as appointed by the
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            <td align="center" width="7%" valign="top">6</td>
            <td align="left" width="30%" valign="top">Reporting Line</td>
            <td align="left" width="60%">You shall report to Vice President Marketing, or any other officer as appointed by
                the Company.
            </td>
        </tr>
        <tr>
            <td align="center" width="7%" valign="top">7</td>
            <td align="left" width="30%" valign="top">Target to be Met<br>(Kindly Note)</td>
            <td align="left" width="60%">A minimum of five (5) students per month for the first six (6) months.
                This will be reviewed at the end of the first three (3) months to monitor progress which if not encouraging may result in cessation of employment.</td>
        </tr>
        <tr>
            <td align="center" width="7%" valign="top">8</td>
            <td align="left" width="30%" valign="top">Working Hours</td>
            <td align="justify" width="60%"><p>Monday to Thursday – 9.00 am to 5.00 pm (lunch break 1.00 pm to 2.00 pm)<br>
                    Friday - 9.00 am to 5.30 pm (Lunch break 12.30 pm to 2.45 pm)<br>
                    Saturday - 9.00 am to 1.00 pm<br>
                    You are to note that as you are employed to work in our Marketing Department, you required to work on Saturdays from 9.00 am to 1.00 pm when applicable.
                </p></td>
        </tr>
        <tr>
            <td align="center" width="7%" valign="top">9</td>
        ...
        <table width="100%" class="table spacebar">
        <tr>
            <td align="center" width="7%" valign="top">10</td>
            <td align="left" width="30%" valign="top">Annual leave during your contract period</td>
        ...
        <tr>
            ...
            <td align="left" width="30%" valign="top">Sick Leave and Hospitalization leave during your contract period</td>
        ...
        <tr>
            ...
            <td align="justify" width="60%"><u>During Probation</u><br>
                ...
                Two (2) months’ notice from either party or two (2) months’ salary in lieu of such notice.<br><br>
            </td>
        </tr>
        </table>
    <div style='page-break-after:always'>&nbsp;</div>
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="60%">
                The Company reserves the right to either reduce or waive the notice period if the Management deems that it would be in the Company’s interest to do so.<br><br>
                ...
                the Company reserves the right to inform your new employer that you quit without giving due notice and legal action is being pursued by the Company
            </td>
        </tr>
            <tr>
        ...
        <td align="center" width="10%" valign="top">15</td>
            ...
            You shall never at any time during and after your employment with the Company disclose or divulge to any
                ...
                You shall not, except with prior written consent of
                 the Chairman of the Board of Directors make direct or indirect
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%">
                During your employment with the Company, we will naturally wish your conduct to be such as not to discredit you or the Company
                and you will be expected to perform the duties assigned to you in a loyal, efficient, trustworthy and honest fashion.<br><br>

                During the continuance of your employment with the Company, you will at all times faithfully and diligently perform and observe
                such duties as may from time to time be assigned to you by your superior and devote the whole of your time and attention to the
                discharge of the duties and functions devolved upon you.<br><br>
                ...
                without formal approval of the Chairman of the Board of Directors.  Breaching this would be a violation of your employment contract and
                could result in the termination of your employment.  You shall not divulge any matters, which may come to your knowledge, relating to the
                affairs of the Company or its employees.

            </td>
        </tr>
        <tr>
            <td align="center" width="10%" valign="top">21</td>
    ...
    <htmlpageheader name="lastpage" style="display:none">
    <div style='page-break-after:always'>&nbsp;</div>
    </htmlpageheader>
