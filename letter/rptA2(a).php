...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">A2(a)</div>');
...
');
    ...
    <p align="justify">Your employment under a fixed term contract expires on <b><?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?></b>.<br><br>
    We are pleased to offer you employment on a contract of serice basis as <b><?php getPosition($result['position_id'],$db);?></b> under <b><?php getFaculty($result['department_id'],$db);?></b> with City University (“The Company”) effective from
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="left" width="60%">You shall report to <b>Dean, <?php getFaculty($result['department_id'],$db);?></b>, or any other officer as appointed by
                the Company.
            </td>
        </tr>
        <tr>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%">
                ...
                will only be considered and accepted at the end of current semester.<br><br>
