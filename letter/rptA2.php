...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">A2</div>');
...
');
    ...
    <table width="100%">
        <tr>
            ...
            <td>&nbsp;:&nbsp;CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-A2</td>
        </tr>
        <tr>
            <td>Date</td>
    ...
    <table width="100%" class="adress">
        ...
        <tr>
            <td border="0010"><b>RE: OFFER OF PERMANENT EMPLOYMENT</b></td>
        </tr>
        <tr>
            <td>
                <hr class="hr">
    ...
    <tr>
    <td align="justify">Your employment under a fixed term contract expires on <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?>.</td>
    </tr>
    </table>
    <table width="100%">
    <tr>
    <td align="justify" style="line-height:170%;">We are pleased to offer you employment on a contract of service basis with effect from <?php  echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start'])) ;?> and the position offered is <?php getPosition($result['position_id'],$db);?> and at salary of RM <?php money($result['salary']);?> (Ringgit Malaysia: <?php upper($obj->words) ?> only) per month.</td>
    </tr>
    </table>
    <table width="100%" class="spacebar">
    <tr>
    <td>Please refer to Appendix A attached herewith on the terms and conditions of employment.</td>
    </tr>
</table>
    <table width="100%" class="spacebar">
    <tr>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-A2</td>
        </tr>
        <tr>
            <td colspan="2">
                <hr class="hr">
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Our Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-A2</td>
        </tr>
    </table>
    ...
    <table width="100%" class="table">
        ...
        <tr>
         ...
         <tr>
            ...
            <td align="left" width="62%">Not Applicable</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" width="6%" class="spacebar">6</td>
            <td align="left" width="32%" class="spacebar">Reporting Line</td>
        ...
        <tr>
            <td align="center" width="6%" class="spacebar">7</td>
            <td align="left" width="32%" class="spacebar">Working Hours</td>
            <td align="justify" width="62%" class="spacebar"><p>Monday to Thursday – 8.30 am to 5.30 pm<br>(lunch break 1.00 pm to 2.00 pm)<br>
                    Friday – 8.30 am to 5.45 pm <br>(Lunch break 12.30 pm to 2.45 pm)<br>
        ...
        <tr>
            ...
            <td align="left" width="32%" valign="top" class="spacebar">Duties & Responsibilities<br>
                i) Job Description<br>
                ii) Class cancelation
            </td>
            <td align="left" width="62%" valign="top" class="spacebar"><br>-Please refer to your Job Description (Attached)<br>
                -Unauthorized cancellation of scheduled classes or preparing and computing fictitious student class attendance records are considered major misconducts (either one or both) and shall result in dismissal from service.
            </td>
        </tr>
        <tr>
            ...
            <td align="justify" width="62%" class="spacebar"><?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>) working days per completed year of service. Leave shall be
                applied 7 days in advance.
            </td>
        </tr>
        <tr>
        <td align="center" width="6%" valign="top" class="spacebar">10</td>
         <td align="left" width="32%" valign="top" class="spacebar">Sick Leave and Hospitalization leave</td>
         <td align="justify" width="62%" class="spacebar">You will be granted paid outpatient medical leave of up to Fourteen (14) days per
                annum. Hospitalization medical leave will be granted up to a maximum of</td>
        </tr>
    </table>
       <div style='page-break-after:always'>&nbsp;</div>
       <br><br>
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="62%">sixty (60) days per completed
                year of service.<br>
        ...
        <tr>
            ...
            <td align="justify" width="62%">You may be transferred or seconded to another department/faculty or any of
        ...
        <tr>
            ...
            <td align="justify" width="62%">
                ...
                will only be considered and accepted at the end of current academic calendar.<br>

                <u>Note : Resignation of Academic Staff</u><br>

                As the Company is involved in providing education and in order not to disrupt completion of modules/subjects
                being taught, academic staff will have to ensure that the last day of service is to coincide either with the
                last day of semester or the day immediately preceding the commencement of the semester, subject to the
                contractual notice period.<br>
        ...
        <td align="justify" width="62%">Upon registration with the Human Resources Department, you will be covered
                under the Company’s Healthcare Plan.</td>
        </tr>
    </table>
    <div style='page-break-after:always'>&nbsp;</div>
    <br><br>
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="62%">
                ...
                The Company shall provide outpatient and other medical expenses for you and your immediate family (legal spouse and children) up to a combined limit of RM 800.00 (Ringgit Malaysia: Eight Hundred Only) per completed year of service.
...
Please refer to the Employee Handbook on Medical/Sick Leave.
         ...
         <tr>
                ...
                <td align="justify" width="62%">You shall never at any time during and after your employment with the Company disclose or divulge to
                    ...
                    press or in books, magazines, periodicals or by advertisement,</td>
          </tr>
    </table>
    ...
    <div style='page-break-after:always'>&nbsp;</div>
        ...
        <table width="100%" class="table spacebar">
            <tr>
                ...
                <td align="left" width="32%" valign="top">&nbsp;</td>
                <td align="justify" width="62%">
                    radio, televisions, film, internet or
            ...
            <tr>
                ...
                Board of Directors.<br><br><br><br><br>                
                </td>
            </tr>
            </table>
                <div style='page-break-after:always'>&nbsp;</div>
        ...
        <td align="justify" width="62%">All notices hereunder shall be made in writing and sent to the other party either in person, via an
                ...
                days after being duly deposited at the post office.<br><br><br><br><br><br><br></td>
        </tr>
        </table>
       ...
       <br><br>
         ...
         <tr>
          ...
          <tr>
            ...
            <td align="justify" width="62%">
                <b>I. CONDUCT </b><br>
                During your employment with City University, we will naturally wish your conduct to be such as
                ...
                affairs of the Company or its employees.<br><br><br><br><br>
            </td>
        </tr>
    </table>
    <div style='page-break-after:always'>&nbsp;</div>
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="62%">
                ...
                quality of education provided by the Company.<br>

                Should such requirement(s) arise it is your sole responsibility to upgrade your skills/qualifications
                etc. in order to comply with the government requirements/regulations e.g.: the need for certain category
                of academic staff to have a teaching methodology certificate.
