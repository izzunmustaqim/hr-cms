...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">C1(MKT)</div>');
...
');
    ...
    <table width="100%">
        <tr>
            ...
            <td>&nbsp;:&nbsp;CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C1(MKT)</td>
        </tr>
        <tr>
            <td>Date</td>
...
You are also to note that once acceptance of this employment offer is confirmed by you and if you do not report to work on the specified date in Appendix A, you may subject yourself to legal action by City University.
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Our Ref: CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C1(MKT)</td>
        </tr>
    </table>
    ...
    <div style='page-break-after:always'>&nbsp;</div>
        ...
        <table width="100%" class="table spacebar">
            <tr>
                ...
                <td align="justify" width="62%">
                    except with prior written consent of the Chairman of the Board of Directors make direct or indirect statements public, whether to the
                   press or in
