...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">AC3(3)</div>');
    $mpdf->SetHTMLFooter('
  ...
  <sethtmlpageheader name="fourthpage" value="on" show-this-page="1"/>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="62%">
                   Fifteen (15) working days per completed year of service. Leave shall be applied 7 days in advance.<br>
