...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">C4</div>');
    $mpdf->SetHTMLFooter('
...
<br><br>
    ...
    <table width="100%">
        <tr>
            ...
            <td>&nbsp;:&nbsp;CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C4</td>
        </tr>
        <tr>
            <td>Date</td>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Ref: CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C4</td>
        </tr>
        <tr>
            <td colspan="2">
                <hr class="hr">
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Our Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C4</td>
        </tr>
    </table>
...
<tr>
        ...
        <tr>
            ...
            <td align="justify" width="62%" class="spacebar"><?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>              ) working days. Leave shall be
                applied 7 days in advance and is to be exhausted before expiry of contract.</td>
        </tr>
    </table>
<div style='page-break-after:always'>&nbsp;</div>
<br><br>
...
<tr>
        ...
        <tr>
            ...
            <td align="justify" width="62%">  
                ...
                Two (2) week’s notice from either party or two (2) week’s salary in lieu of such notice.<br><br>
...
Please refer to Employee Handbook on Medical/Sick Leave.<br><br><br><br><br><br><br><br>
...
<td align="left" width="32%" valign="top">Notice</td>
<td align="justify" width="62%">
