...
<br>
    ...
    <table width="100%" class="adress">
     ...
     <td align="justify">We are pleased to engage you on a contract for service basis on the following terms and conditions:-</td>
      ...
      <table width="100%">
        <tr>
            <td align="left" width="24%" class="spacebar">1.0 Position</td>
            <td align="center" width="10%" class="spacebar">:</td>
            <td align="left" width="66%" class="spacebar"><?php getPosition($result['position_id'],$db);?></td>
        </tr>
        <tr>
            <td align="left" width="24%" valign="top" class="spacebar">2.0 Reporting line</td>
            <td align="center" width="10%" valign="top" class="spacebar">:</td>
            <td align="justify" width="66%" class="spacebar"><p>You shall report to the <?php echo $result['report_to_id'];?>, <?php getFaculty($result['department_id'],$db);?> or to any other person designated by the Company
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="justify" width="66%"><p><?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start']));?> to – <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end']));?></p>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td align="left" width="24%" valign="top">5.0 Total Fees</td>
            <td align="center" width="10%" valign="top">:</td>
...
<div style='page-break-after:always'>&nbsp;</div>
 ...
 <td valign="top" align="left"><b>Termination of Contract (Academic)</b><br>&nbsp;</td>
 </tr>
 <tr>
<td width="7%" align="left" valign="top">&nbsp;</td>
<td width="93%" align="justify" valign="top"><p>During the Contract Period this contract for Service can be terminated by either party giving to the other three (3) months’ notice or three (3) months’ fees in lieu of notice. You are however to note that should you wish to terminate the contract, it will only be considered and accepted at the end of current academic calendar. You are however to note that should you wish to terminate the contract, your last day of service should coincide with the end of current academic calendar or the day immediately preceding the commencement of the semester.</p><br>&nbsp;</td>
</tr>
  <tr>
<td width="7%" align="left" valign="top">&nbsp;</td>
<td width="93%" align="justify" valign="top">
<table width="100%" class="spacebar">
<tr>
<td>6.1</td>
<td align="justify">Your contract with City University may be terminated without prior notice if you:-</td>
</tr>
</table>
  <table width="100%" class="spacebar">
        <tr>
...
<tr>
<td>6.2</td>
<td align="justify">Upon termination of your contract for service pursuant to Section 6.1 and under any one (1) of the clauses in 6.1, you shall not be entitled to any payment by way of compensation and you will be required to pay City University a penalty equivalent to the sum of three (3) months of the service fee, except for 6.1(e).</td>
</tr>
</table>
</td>
</tr>
...
<td valign="top" align="left"><b>Relocation</b></td>
</tr>
<tr>
<td width="7%" align="left" valign="top">&nbsp;</td>
<td width="93%" align="justify" valign="top">The Company may at its discretion relocate you to another location, section, department, division, region, branch, subsidiaries or associate company that is in existence or to be created in the future where your service is required.<br>&nbsp;
</td>
</tr>
<tr>
<td valign="top" align="left">8.0</td>
<td valign="top" align="left"><b>Duties and responsibility</b></td>
</tr>
<tr>
<td width="7%" align="left" valign="top">&nbsp;</td>
<td width="93%" align="justify" valign="top">You shall devote full commitment to the service of City University and shall endeavour to the utmost in your capacity to promote the interest and good name of City University. The service you provide shall be subject to the provisions of the Constitution, Statutes, Acts and Rules and Regulations of City University that may be   amended from time to time and to the Laws of Malaysia. Your duties and responsibilities with regard to your contract for service is attached herewith (Appendix A)<br><br>
<table width="100%" class="spacebar">
<tr>
<td>8.1</td>
...
<td valign="top" align="left"><b>Secrecy/Confidentiality</b></td>
</tr>
<tr>
<td width="7%" align="left" valign="top">&nbsp;</td>
<td width="93%" align="justify" valign="top">You shall maintain and observe complete secrecy/confidentiality in respect of any information about City University or City University’s activities, plans and strategies throughout your service, and shall be liable for any acts in breach of this provision.<br>&nbsp;
</td>
</tr>
</table>
<div style='page-break-after:always'>&nbsp;</div>
...
<tr>
<td valign="top" align="left" colspan="2">The onus is on you to declare to Inland Revenue Department the payments you have received from us.</td>
</tr>
</table>
<div style='page-break-after:always'>&nbsp;</div>
<table width="100%" class="spacebar">
