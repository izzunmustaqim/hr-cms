...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">C2</div>');
    $mpdf->SetHTMLFooter('
...
<br><br>
    ...
    <table width="100%">
        <tr>
            ...
            <td>&nbsp;:&nbsp;CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C2</td>
        </tr>
        <tr>
            <td>Date</td>
 ...
 <p align="justify">
Your employment under a fixed term contract expires on <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_end'])) ;?>.<br><br>
   On reviewing your performance, we are pleased to offer you employment on a contract of service basis as <?php getPosition($result['position_id'],$db);?>. Your salary is RM <?php money($result['salary']);?> (Ringgit Malaysia: <?php upper($obj->words) ?> only) per month with effect from <?php echo date('j<\s\up>S</\s\up> F Y',strtotime($result['date_contract_start']));?>.<br><br>
    Please refer to Appendix A attached herewith on the terms and conditions of employment.<br><br>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C2</td>
        </tr>
        <tr>
            <td colspan="2">
                <hr class="hr">
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Our Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C2</td>
        </tr>
    </table>
    ...
    <table width="100%" class="table">
        ...
        <tr>
          ...
          <tr>
            ...
            <td align="left" width="32%" valign="top" class="spacebar">Employment Status</td>
            <td align="left" width="62%" class="spacebar">Permanent</td>
        </tr>
         <tr>
            <td align="center" width="6%" valign="top" class="spacebar">4</td>
            <td align="left" width="32%" valign="top" class="spacebar">Probation</td>
            <td align="left" width="62%" class="spacebar">Not Applicable</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" width="62%" class="spacebar">You shall report to the <?php echo $result['report_to_id'];?> or any other officer as appointed by
                the Company.
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" width="32%" valign="top" class="spacebar">Duties & Responsibilities
            </td>
            <td align="left" width="62%" valign="top" class="spacebar">Please refer to your Job Description (Attached)
            </td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
            ...
            <td align="justify" width="62%">Upon registration with the Human Resources Department, you will be covered
                ...
                be responsible for medical expenses incurred for
    ...
    <table width="100%" class="table spacebar">
        <tr>
            ...
            <td align="justify" width="62%">self-inflicted injuries, suicide attempts, treatment of
...
Please refer to the Employee Handbook on Medical/Sick Leave.
         ...
         <tr>
                ...
                <td align="justify" width="62%">
                    ...
                    any other medium with respect to any matter which might impair or
                </td>
                </tr>
    </table>
