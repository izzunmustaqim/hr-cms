...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">C3</div>');
...
<br>
    ...
    <tr>
    <td align="justify">We are pleased to confirm our offer of employment to you as Marketing <?php getUnit($result['unitid'],$db);?> <?php getPosition($result['position_id'],$db);?> with City University (“The Company”). You will report to the <?php echo $result['report_to_id'];?> or any other officer as appointed by the Company. This position is based at the Petaling Jaya Main Campus at Menara City University.</td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
    <td align="justify">You shall be paid a salary of RM <?php money($result['salary']);?> (Ringgit Malaysia: <?php upper($obj->words) ?> only) per month less statutory deductions.</td>
    </tr>
     <tr><td>&nbsp;</td></tr>
      <tr>
    <td align="justify">The terms and conditions applicable to this appointment is attached herewith (Appendix A).</td>
    </tr>
    <tr><td>&nbsp;</td></tr>
      <tr>
    ...
    <tr>
        ...
        <tr>
            <td align="justify"><p style="line-height:1.5;">I .....................................................,
                    (NRIC/Passport No: .........................................),
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Our Ref: CITYU/HRA/INT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-C3</td>
        </tr>
    </table>
    ...
    <table width="100%" class="table">
    <tr>
    <td width="6%" height="50" align="center"><b>No</b></td>
    <td align="center" width="32%"><b>Item</b></td>
    <td align="center" width="62%"><b>Description</b></td>
    </tr>
     <tr>
        ...
        <tr>
            ...
            <td align="left" width="62%">Marketing <?php getUnit($result['unitid'],$db);?> <?php getPosition($result['position_id'],$db);?>( Job Grade: <?php getPositionGrade($result['position_id'],$db);?> )</td>
        </tr>
          <tr>
            <td align="center" width="6%" valign="top">3</td>
            <td align="left" width="32%" valign="top">Employement Status</td>
            <td align="left" width="62%">Permanent</td>
        </tr>
        <tr>
...
<tr>
            ...
            <td align="left" width="62%">Your probationary period is six (6) months. </td>
        </tr>
        <tr>
          ...
          <tr>
            ...
            <td align="left" width="32%" valign="top" class="spacebar">Target to be Met</td>
            <td align="justify" width="62%" class="spacebar"><p>A minimum of five (5) students per month for the first six (6) months.  This will be reviewed at the end of the first three (3) months to monitor progress which if not encouraging may result in cessation of employment.
                    </p></td>
        </tr>
        <tr>
            <td align="center" width="6%" valign="top" class="spacebar">8</td>
            <td align="left" width="32%" valign="top" class="spacebar">Working Hours</td>
            <td align="justify" width="62%" class="spacebar"><p>Monday to Thursday – 9.00 am to 5.00 pm (lunch break 1.00 pm to 2.00 pm)<br>
                    Friday – 9.00 am to 5.30 pm (Lunch break 12.30 pm to 2.45 pm)<br>
                    Saturday – 9.00 am to 1.00 pm <br>
                    
                    You are to note that as you are employed to work in our Marketing Department, you required to work on Saturdays from 9.00am to 1.00pm when applicable.
                    </p></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" width="6%" valign="top" class="spacebar">10</td>
            <td align="left" width="32%" valign="top" class="spacebar">Annual leave during your contract</td>
            <td align="justify" width="62%" class="spacebar"><?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>) working days. Leave shall be
                ...
                Half of your unutilized leave accrued for the year may be carried forward to the subsequent calendar year.<br>
...
<tr>
            ...
            <td align="justify" width="62%">You will be granted paid outpatient medical leave of up to Fourteen (14) days per
                annum. Hospitalization medical leave will be granted up to a maximum of sixty (60) days.<br>
...
<tr>
        ...
        <tr>
            ...
            <td align="justify" width="62%">  
                ...
                One (1) month’s notice from either party or one (1) month’s salary in lieu of such notice.<br>
                ...
                Two (2) month’s notice from either party or two (2) month’s salary in lieu of such notice. <br><br>
The Company reserves the right to either reduce or waive the notice period by either party if the Management deems that it would be in the Company’s interest to do so.<br>Kindly note with regard to this offer of employment you fully understand and agree that should you resign without giving the due notice or salary in lieu, City University reserves the right to inform 
            </td>
        </tr>
</table>
<div style='page-break-after:always'>&nbsp;</div>
<br><br>
 <table width="100%" class="table spacebar">
   <tr>
            ...
            <td align="justify" width="62%">
            your new employer that you quit without giving due notice and legal action is being pursued by City University.
            </td>
        </tr>
        <tr>
            ...
            <td align="justify" width="62%">Upon registration with the Human Resources Department, you will be covered
                ...
                The Company shall provide outpatient and other medical expenses for you and your immediate family (legal spouse and children) up to a combined limit of RM 800.00 (Ringgit Malaysia: Eight Hundred Only) per annum.<br><br>
          ...
          <tr>
                ...
                <td align="justify" width="62%">
                    You shall never at any time during and after your employment with the Company disclose or divulge to any third party any information or matters relating to the Company or its business partners. This includes but not limited to the Company’s business plans, strategies, program contents or trade secrets.  
                </td>
            </tr>
    </table>
<div style='page-break-after:always'>&nbsp;</div>
...
<table width="100%" class="table spacebar">
 <tr>
            <td align="center" width="6%" valign="top">21</td>
