...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">AC3</div>');
    $mpdf->SetHTMLFooter('
...
<br><br>
    ...
    <table width="100%">
        <tr>
            ...
            <td>&nbsp;:&nbsp;CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-AC3</td>
        </tr>
        <tr>
            <td>Date</td>
    ...
    <table width="100%" class="spacebar">
        <tr>
            <td align="justify" height=""><p>We are pleased to confirm our offer of employment to you as <?php getPosition($result['position_id'],$db);?> under <?php getFaculty($result['department_id'],$db);?>
           with City University (&quot;The Company&quot;). You will report to the <?php echo $result['report_to_id'];?>, <?php getFaculty($result['department_id'],$db);?>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Ref: CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-AC3</td>
        </tr>
        <tr>
            <td colspan="2">
                <hr class="hr">
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">Our Ref: CITYU/HRA/EXT/<?php echo date("Y")?>-<?php padnumber($result['offer_id'])?>-AC3</td>
        </tr>
    </table>
  ...
  <sethtmlpageheader name="fourthpage" value="on" show-this-page="1"/>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="left" width="32%" valign="top">Contract Duration</td>
        ...
        <tr>
            ...
            <td align="justify" width="62%"><p>
                    You shall report to the <?php echo $result['report_to_id'];?>,<?php getFaculty($result['department_id'],$db);?> or any other officer as appointed by the Company.
                </p></td>
        </tr>
        <tr>
            ...
            <td align="justify" width="62%">
                Monday to Thursday – 8.30am to 5.30pm (lunch break 1.00pm to 2.00pm)<br>
         ...
         <tr>
            ...
            <td align="justify" width="62%" valign="top">
                ...
                -Unauthorized cancellation of scheduled classes or preparing and computing fictitious student class attendance records are considered major misconducts (either one or both)</td>
        </tr>
    </table>
    <div style='page-break-after:always'>&nbsp;</div>
    <br><br>
    <table width="100%" class="table spacebar">
         <tr>
            ...
            <td align="justify" width="62%" valign="top">and shall result in dismissal from service.</td>
        </tr>
        <tr>
            <td align="center" width="6%" valign="top">9</td>
            <td align="left" width="32%" valign="top">Annual leave</td>
            <td align="justify" width="62%">
                    <?php getEntitlementName($result['position_id'],$db);?> (<?php getEntitlement($result['position_id'],$db);?>) working days per completed year of service. Leave shall be applied 7 days in advance.<br>
        ...
        <tr>
            ...
            <td align="justify" width="62%">
                One (1) month notice from either party or one (1) month salary in lieu of such notice.<br>
                If an employee's services are terminated at the end of the probationary period, kindly note that the question of giving notice with regard to termination of employment shall not arise.<br>
       ...
       <tr>
          ...
          <tr>
              ...
              <td align="justify" width="62%">
                  ...
                  third party any information or matters relating to the Company or its business partners.
              </td>
          </tr>
      </table>
      <div style='page-break-after:always'>&nbsp;</div>
      ...
      <table width="100%" class="table spacebar">
       <tr>
              ...
              <td align="justify" width="62%">
              This includes
                  but not limited to the Company’s business plans, strategies, program contents or trade secrets.
