...
');
    ...
    <table width="100%" class="spacebar">
        <tr>
            <td align="justify" height=""><p>We are pleased to confirm our offer of employment to you as <b><?php getPosition($result['position_id'],$db);?></b>
                    under <b><?php getFaculty($result['department_id'],$db);?></b> with City University (&quot;The
                    Company&quot;). You will be reporting to the <b><?php echo $result['report_to_id'];?></b> or any other officer as appointed by the
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            <td align="justify"><p>I ........................................................, (Identity Card No:
                    ........................................), hereby accept the terms and
  ...
  <sethtmlpageheader name="fourthpage" value="on" show-this-page="1"/>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%"><p>
                    You shall report to the <b><?php echo $result['report_to_id'];?></b> or any other officer as appointed by the Company.
                </p></td>
        </tr>
        <tr>
    ...
    <table width="100%" class="table spacebar">
        ...
        <tr>
            ...
            <td align="justify" width="60%">Upon registration with the Human Resource Department, you will be covered
                ...
                be responsible for medical expenses
            </td>
        </tr>
    </table>
      <div style='page-break-after:always'>&nbsp;</div>
      ...
      <table width="100%" class="table spacebar">
          <tr>
              ...
              <td align="justify" width="60%">incurred for self-inflicted injuries, suicide attempts, treatment of
      ...
      <table width="100%" class="table spacebar">
          <tr>
              ...
              <td align="left" width="30%" valign="top"></td>
              <td align="justify" width="60%">
                  any matter which might impair or injure the reputation of the Company or the
