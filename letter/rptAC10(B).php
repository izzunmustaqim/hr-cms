...
foreach($result as $result) {
    ...
    $mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 22pt;  ">AC10(B)</div>');
...
');
   ...
   <style>
    ...
    <table width="100%">
        ...
        <tr>
            <td border="0010"><b>APPOINTMENT AS AN ADVISOR (ACADEMIC)</b></td>
        </tr>
        <tr>
            <td>
                <hr class="hr">
...
<?php getPosition($result['position_id'],$db);?>
        ...
        <tr>
            ...
            <td align="justify" width="66%" class="spacebar" valign="top"><p>You shall report to the <?php echo $result['report_to_id'];?> of the <?php getFaculty($result['department_id'],$db);?> or to any other person designated by the Company.
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" width="24%" valign="top" class="spacebar">4.0 Location</td>
            <td align="center" width="10%" valign="top" class="spacebar">:</td>
        ...
        <tr>
            <td align="left" width="24%" valign="top" class="spacebar">5.0 Honorarium</td>
            <td align="center" width="10%" valign="top" class="spacebar">:</td>
            <td align="justify" width="66%" valign="top" class="spacebar"><p>RM <?php money($result['salary']);?> (Ringgit Malaysia: <?php upper($obj->words) ?> only) <?php getDuration($result['duration_id'])?></p></td>
        </tr>
    </table>
    ...
    <table width="100%" class="spacebar">
        ...
        <tr>
            ...
            <td valign="top" align="justify"><p>During the Contract Period this contract for Service can be terminated
                    by either party giving to the other three (3) month's notice or three (3) month's fees in lieu of
    ...
    <br>
                ...
                <td width="6%">&nbsp;</td>
                <td width="3%">6.2</td>
                <td width="91%" align="justify">Upon termination of your contract for service pursuant to Section 6.1 and
                under any one (1) of the clauses, you shall not be entitled to any payment by way of compensation and
                you will be required to pay City University a penalty equivalent to the sum of three (3) month of the service fee, except for 6.1(e).</td>
                </tr>
                </table>
    <div style='page-break-after:always'>&nbsp;</div>
    <table width="100%" class="spacebar">
...
<td align="justify">You agree that this appointment shall not create any permanent employment relationship that falls
    ...
    <table width="100%">
    <tr>
            <td align="justify">Other terms and conditions of employment shall be in accordance to the “<b>Appendix A</b>” attached.
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
